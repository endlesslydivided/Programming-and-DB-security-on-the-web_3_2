...
CREATE NONCLUSTERED INDEX index_OrderUA ON [Order](UnitsAmount);
...
CREATE NONCLUSTERED INDEX index_OrderUAAsc ON [Order](UnitsAmount asc);
...
CREATE NONCLUSTERED INDEX index_OrderUADesc ON [Order](UnitsAmount desc);
...
CREATE NONCLUSTERED INDEX index_ServiceCPU ON Service(CostPerUnit);
...
CREATE NONCLUSTERED INDEX index_ServiceCPUAsc ON Service(CostPerUnit asc );
...
CREATE NONCLUSTERED INDEX index_ServiceCPUDesc ON Service(CostPerUnit desc);
