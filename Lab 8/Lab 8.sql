...
INSERT INTO bfile_table VALUES ( 'pdf', BFILENAME( 'BFILE_DIR', 'lab-01.pdf' ) );
SELECT * FROM bfile_table;
...
DECLARE
  ...
  v_amount   INTEGER;
BEGIN
  v_src_loc := BFILENAME('BFILE_DIR', 'lab-01.pdf');
  INSERT INTO bfile_table  
  VALUES ('pdf', empty_blob()) RETURN doc INTO l_blob; 
  DBMS_LOB.FILEOPEN(v_src_loc, DBMS_LOB.LOB_READONLY);
  v_amount := DBMS_LOB.GETLENGTH(v_src_loc);
  DBMS_LOB.LOADFROMFILE(l_blob, v_src_loc, v_amount);
  DBMS_LOB.FILECLOSE(v_src_loc);
