...
spool "TRANSDB MIGRATION_&filename..log"

-- Password file execution
@passworddefinition.sql

PROMPT Dropping Role ROLE_TRANSDB_MIGRATION ...
DROP ROLE ROLE_TRANSDB_MIGRATION ;
PROMPT Creating Role ROLE_TRANSDB_MIGRATION ...
CREATE ROLE ROLE_TRANSDB_MIGRATION ;
...
GRANT ALL ON utils TO ROLE_TRANSDB_MIGRATION;
...
GRANT ALL ON Order_ TO ROLE_TRANSDB_MIGRATION;
...
GRANT ALL ON City TO ROLE_TRANSDB_MIGRATION;
...
GRANT ALL ON TR_AUDIT TO ROLE_TRANSDB_MIGRATION;
...
GRANT ALL ON Service TO ROLE_TRANSDB_MIGRATION;
...
GRANT ALL ON ServiceType TO ROLE_TRANSDB_MIGRATION;
...
GRANT ALL ON cityCoord TO ROLE_TRANSDB_MIGRATION;
...
GRANT ALL ON geometry_columns TO ROLE_TRANSDB_MIGRATION;
...
GRANT ALL ON Customer TO ROLE_TRANSDB_MIGRATION;
...
GRANT ALL ON Geo TO ROLE_TRANSDB_MIGRATION;
...
GRANT ALL ON map TO ROLE_TRANSDB_MIGRATION;
...
GRANT ALL ON spatial_ref_sys TO ROLE_TRANSDB_MIGRATION;
...
GRANT ALL ON Route TO ROLE_TRANSDB_MIGRATION;
...
GRANT ALL ON OrdersWithServices TO ROLE_TRANSDB_MIGRATION;
...
GRANT ALL ON NumberRouteOrders TO ROLE_TRANSDB_MIGRATION;
...
GRANT ALL ON CityRoutesDeparture TO ROLE_TRANSDB_MIGRATION;
...
END;
/
GRANT ALL ON getDistanse TO ROLE_TRANSDB_MIGRATION;
...
END;
/
GRANT ALL ON TGetOrdersByDate TO ROLE_TRANSDB_MIGRATION;
...
END;
/
GRANT ALL ON TGetOrdersQByCompany TO ROLE_TRANSDB_MIGRATION;
/*Global Temporary Tables:1 *//* Translation Extracted DDL For Required Objects*/
...
END;
/
GRANT ALL ON TGetRelevantRoutesByCompany TO ROLE_TRANSDB_MIGRATION;
...
END;
/
GRANT ALL ON addChildNode TO ROLE_TRANSDB_MIGRATION;
...
END;
/
GRANT ALL ON AI_ORDERS TO ROLE_TRANSDB_MIGRATION;
...
END;
/
GRANT ALL ON getRoot TO ROLE_TRANSDB_MIGRATION;
...
END;
/
GRANT ALL ON TCity TO ROLE_TRANSDB_MIGRATION;
...
END;
/
GRANT ALL ON TCustomer TO ROLE_TRANSDB_MIGRATION;
...
END;
/
GRANT ALL ON TOrder TO ROLE_TRANSDB_MIGRATION;
...
END;
/
GRANT ALL ON TRoute TO ROLE_TRANSDB_MIGRATION;
...
END;
/
GRANT ALL ON TServiceType TO ROLE_TRANSDB_MIGRATION;
...
END;
/
GRANT ALL ON TServices TO ROLE_TRANSDB_MIGRATION;
set define on
prompt connecting to TRANS
alter session set current_schema=TRANS;
set define off
